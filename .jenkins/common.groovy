...
def runCompileCommand(platform, project, jobName, boolean debug=false)
{
    ...
    def command = """#!/usr/bin/env bash
            ...
            cmake -Wdev --debug-output --trace -DCMAKE_BUILD_TYPE=${buildType} -DCMAKE_CXX_COMPILER=${compiler} -DCODE_OBJECT_VERSION=${cov} -DTensile_ROOT=\$(pwd)/../Tensile ../HostLibraryTests
            make -j\$(nproc)
